...
symbol=int(input("How many sympols do you want in your password?: "))
number=int(input("How many lowercase numbers do you want in your password?: "))
